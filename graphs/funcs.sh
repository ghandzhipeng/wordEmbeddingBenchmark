...
rpr_sampling_source_vec=$output_dir/rpr_sampling_source.vec
rpr_sampling_dest_vec=$output_dir/rpr_sampling_dest.vec
rpr_mf_source_vec=$output_dir/rprmf_source.vec
rpr_mf_dest_vec=$output_dir/rprmf_dest.vec
...
rpr_node_rec(){
    java -cp EmbeddingFrameWork.jar:jcommander-1.60.jar:ejml-0.25.jar JudgeTools.RPRNodeRec --thread_num $thread_num --path_train_data $path_train_data --path_test_data $path_test_data --topk $topk --node_num $node_num $1
}

wrpr_node_rec(){
    java -cp EmbeddingFrameWork.jar:jcommander-1.60.jar:ejml-0.25.jar JudgeTools.WeightedRPRNodeRec --thread_num $thread_num --path_train_data $path_train_data --path_test_data $path_test_data --topk $topk --node_num $node_num $1
}
rrpr_node_rec(){
    java -cp EmbeddingFrameWork.jar:jcommander-1.60.jar:ejml-0.25.jar JudgeTools.ReverseRPRNodeRec --thread_num $thread_num --path_train_data $path_train_data --path_test_data $path_test_data --topk $topk --node_num $node_num $1
}
simrank_node_rec(){
...
# Embedding Tools
app_embedding(){
    java -cp EmbeddingFrameWork.jar:jcommander-1.60.jar:ejml-0.25.jar EmbeddingTools.APP --path_train_data $path_train_data --path_source_vec $path_source_vec --path_dest_vec $path_dest_vec --node_num $node_num --neg_sample 5 --layer_size 64 --sample 200 --max_step 10 --iter $iter_num --jump_factor 0.2f --learning_rate 0.01 $1
}
rpr_sampling(){
    java -cp EmbeddingFrameWork.jar:jcommander-1.60.jar:ejml-0.25.jar EmbeddingTools.RPRSampling --path_train_data $path_train_data --path_source_vec $path_source_vec --path_dest_vec $path_dest_vec --node_num $node_num --neg_sample 5 --layer_size 64 --iter $iter_num --learning_rate $learning_rate --threshold $threshold  --thread_num $thread_num --topk $topk_sampling $1
}
wrpr_sampling(){
    java -cp EmbeddingFrameWork.jar:jcommander-1.60.jar:ejml-0.25.jar EmbeddingTools.WRPRSampling --path_train_data $path_train_data --path_source_vec $path_source_vec --path_dest_vec $path_dest_vec --node_num $node_num --neg_sample 5 --layer_size 64 --iter $iter_num --learning_rate $learning_rate --threshold $threshold  --thread_num $thread_num --topk $topk_sampling $1
}
...
rpr_mf(){
    java -cp EmbeddingFrameWork.jar:jcommander-1.60.jar:ejml-0.25.jar EmbeddingTools.RPRMF --path_train_data $path_train_data --path_source_vec $path_source_vec --path_dest_vec $path_dest_vec --node_num $node_num --neg_sample 5 --layer_size 64 --iter $iter_num --learning_rate $learning_rate --threshold $threshold $1
}
jaccard_mf(){
