...
#
#echo "compile $path_embedding into the format of npz"
#python ../hyperwords/text2npz.py $path_embedding
#
#python ../hyperwords/ws_eval.py SIMI $path_embedding ../testsets/ws/ws353.txt
#python ../hyperwords/analogy_eval.py SIMI $path_embedding ../testsets/analogy/google.txt
