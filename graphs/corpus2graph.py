...
# difference from the existing construction: directed, window = 1


def main():
    args = docopt("""
    Usage:
        corpus2graph.py [options] <corpus>
    ...
    with open(corpus_file) as f: 
        for line in f:
            ...
            #         if end > len_tokens:
            #             end = len_tokens
            #         # whether position is output to the pairs file
            #         if pos:
